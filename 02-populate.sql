...
-- Observação: Se você estiver usando um schema específico (ex: minha_plataforma),
-- lembre-se de prefixar os nomes das tabelas (ex: minha_plataforma."User").
-- Para este script, assumimos que as tabelas estão no schema padrão (public).
...
-- Inserindo dados na tabela Task
...
-- Inserindo dados na tabela Matricula_Projetos
...
-- Inserindo dados na tabela Task_estudante
