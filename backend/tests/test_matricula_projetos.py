...
class TestMatriculaProjetosEndpoints:
    
    @pytest.mark.asyncio
    async def test_create_matricula(self, client: AsyncClient, sample_estudante, sample_projeto):
        matricula_data = {
    ...
    @pytest.mark.asyncio
    async def test_create_matricula_invalid_student(self, client: AsyncClient, sample_projeto):
        matricula_data = {
            "student_id": 999,
            "projeto_id": sample_projeto.projeto_id,
            "status": "Ativo"
    ...
    @pytest.mark.asyncio
    async def test_create_matricula_invalid_project(self, client: AsyncClient, sample_estudante):
        matricula_data = {
            "student_id": sample_estudante.student_id,
            "projeto_id": 999,
            "status": "Ativo"
    ...
    @pytest.mark.asyncio
    async def test_create_duplicate_matricula(self, client: AsyncClient, sample_estudante, sample_projeto):
        matricula_data = {
            "student_id": sample_estudante.student_id,
            "projeto_id": sample_projeto.projeto_id,
            "status": "Ativo"
    ...
    @pytest.mark.asyncio
    async def test_read_matriculas(self, client: AsyncClient, db_session, sample_estudante, sample_projeto):
    ...
    @pytest.mark.asyncio
    async def test_read_matriculas_with_pagination(self, client: AsyncClient, db_session, sample_estudante, sample_projeto):
        # Create a matricula first
        from app.models import MatriculaProjetos
        matricula = MatriculaProjetos(
            student_id=sample_estudante.student_id,
    ...
    @pytest.mark.asyncio
    async def test_read_matricula_by_id(self, client: AsyncClient, db_session, sample_estudante, sample_projeto):
        # Create a matricula first
        from app.models import MatriculaProjetos
        matricula = MatriculaProjetos(
            student_id=sample_estudante.student_id,
    ...
    @pytest.mark.asyncio
    async def test_read_matricula_not_found(self, client: AsyncClient):
        response = await client.get("/matriculas/999")
        assert response.status_code == 404
        assert "Matricula not found" in response.json()["detail"]

    @pytest.mark.asyncio
    async def test_update_matricula(self, client: AsyncClient, db_session, sample_estudante, sample_projeto):
        # Create a matricula first
        from app.models import MatriculaProjetos
        matricula = MatriculaProjetos(
            student_id=sample_estudante.student_id,
    ...
    @pytest.mark.asyncio
    async def test_update_matricula_not_found(self, client: AsyncClient):
        update_data = {
            "status": "Concluído"
        }
    ...
    @pytest.mark.asyncio
    async def test_delete_matricula(self, client: AsyncClient, db_session, sample_estudante, sample_projeto):
        # Create a matricula first
        from app.models import MatriculaProjetos
        matricula = MatriculaProjetos(
            student_id=sample_estudante.student_id,
    ...
    @pytest.mark.asyncio
    async def test_delete_matricula_not_found(self, client: AsyncClient):
        response = await client.delete("/matriculas/999")
        assert response.status_code == 404
        assert "Matricula not found" in response.json()["detail"]

    @pytest.mark.asyncio
    async def test_read_matriculas_by_student(self, client: AsyncClient, db_session, sample_estudante, sample_projeto):
        # Create a matricula first
        from app.models import MatriculaProjetos
        matricula = MatriculaProjetos(
            student_id=sample_estudante.student_id,
    ...
    @pytest.mark.asyncio
    async def test_read_matriculas_by_project(self, client: AsyncClient, db_session, sample_estudante, sample_projeto):
        # Create a matricula first
        from app.models import MatriculaProjetos
        matricula = MatriculaProjetos(
            student_id=sample_estudante.student_id,
