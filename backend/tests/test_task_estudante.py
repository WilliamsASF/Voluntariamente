...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_create_task_estudante(client: AsyncClient, sample_estudante, sample_task):
    task_estudante_data = {
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_create_task_estudante_invalid_student(client: AsyncClient, sample_task):
    task_estudante_data = {
        "student_id": 999,
        "task_id": sample_task.task_id,
        "status": "Ativo"
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_create_task_estudante_invalid_task(client: AsyncClient, sample_estudante):
    task_estudante_data = {
        "student_id": sample_estudante.student_id,
        "task_id": 999,
        "status": "Ativo"
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_create_duplicate_task_estudante(client: AsyncClient, sample_estudante, sample_task):
    task_estudante_data = {
        "student_id": sample_estudante.student_id,
        "task_id": sample_task.task_id,
        "status": "Ativo"
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_task_estudantes(client: AsyncClient, db_session, sample_estudante, sample_task):
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_task_estudantes_with_pagination(client: AsyncClient, db_session, sample_estudante, sample_task):
    # Create a task_estudante first
    from app.models import TaskEstudante
    task_estudante = TaskEstudante(
        student_id=sample_estudante.student_id,
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_task_estudante_by_id(client: AsyncClient, db_session, sample_estudante, sample_task):
    # Create a task_estudante first
    from app.models import TaskEstudante
    task_estudante = TaskEstudante(
        student_id=sample_estudante.student_id,
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_task_estudante_not_found(client: AsyncClient):
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_update_task_estudante(client: AsyncClient, db_session, sample_estudante, sample_task):
    # Create a task_estudante first
    from app.models import TaskEstudante
    task_estudante = TaskEstudante(
        student_id=sample_estudante.student_id,
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_update_task_estudante_not_found(client: AsyncClient):
    update_data = {
        "status": "Concluído"
    }
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_delete_task_estudante(client: AsyncClient, db_session, sample_estudante, sample_task):
    # Create a task_estudante first
    from app.models import TaskEstudante
    task_estudante = TaskEstudante(
        student_id=sample_estudante.student_id,
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_delete_task_estudante_not_found(client: AsyncClient):
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_task_estudantes_by_student(client: AsyncClient, db_session, sample_estudante, sample_task):
    # Create a task_estudante first
    from app.models import TaskEstudante
    task_estudante = TaskEstudante(
        student_id=sample_estudante.student_id,
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_task_estudantes_by_task(client: AsyncClient, db_session, sample_estudante, sample_task):
    # Create a task_estudante first
    from app.models import TaskEstudante
    task_estudante = TaskEstudante(
        student_id=sample_estudante.student_id,
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_task_estudantes_by_status(client: AsyncClient, db_session, sample_estudante, sample_task):
    # Create a task_estudante first
    from app.models import TaskEstudante
    task_estudante = TaskEstudante(
        student_id=sample_estudante.student_id,
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_task_estudantes_by_status_no_results(client: AsyncClient):
