...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_create_projeto(client: AsyncClient, sample_disciplina, sample_ong):
    projeto_data = {
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_create_projeto_minimal(client: AsyncClient):
    projeto_data = {
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_projetos(client: AsyncClient, sample_projeto):
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_projetos_with_pagination(client: AsyncClient, sample_projeto):
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_projeto_by_id(client: AsyncClient, sample_projeto):
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_projeto_not_found(client: AsyncClient):
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_update_projeto(client: AsyncClient, sample_projeto):
    update_data = {
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_update_projeto_not_found(client: AsyncClient):
    update_data = {
        "name": "Updated Project Name"
    }
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_delete_projeto(client: AsyncClient, sample_projeto):
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_delete_projeto_not_found(client: AsyncClient):
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_projetos_by_disciplina(client: AsyncClient, sample_projeto, sample_disciplina):
...
@pytest.mark.asyncio
@pytest.mark.asyncio
async def test_read_projetos_by_ong(client: AsyncClient, sample_projeto, sample_ong):
