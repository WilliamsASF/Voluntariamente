...
class TestDisciplinaEndpoints:
    
    @pytest.mark.asyncio
    async def test_create_disciplina(self, client: AsyncClient, sample_professor):
        disciplina_data = {
    ...
    @pytest.mark.asyncio
    async def test_create_disciplina_without_professor(self, client: AsyncClient):
        disciplina_data = {
    ...
    @pytest.mark.asyncio
    async def test_create_disciplina_invalid_professor(self, client: AsyncClient):
        disciplina_data = {
            "professor_id": 999,
    ...
    @pytest.mark.asyncio
    async def test_read_disciplinas(self, client: AsyncClient, sample_disciplina):
    ...
    @pytest.mark.asyncio
    async def test_read_disciplinas_with_pagination(self, client: AsyncClient, sample_disciplina):
    ...
    @pytest.mark.asyncio
    async def test_read_disciplina_by_id(self, client: AsyncClient, sample_disciplina):
    ...
    @pytest.mark.asyncio
    async def test_read_disciplina_not_found(self, client: AsyncClient):
        response = await client.get("/disciplinas/999")
        assert response.status_code == 404
        assert "Disciplina not found" in response.json()["detail"]

    @pytest.mark.asyncio
    async def test_update_disciplina(self, client: AsyncClient, sample_disciplina):
        update_data = {
    ...
    @pytest.mark.asyncio
    async def test_update_disciplina_not_found(self, client: AsyncClient):
        update_data = {
            "nome_disciplina": "Updated Subject Name"
        }
    ...
    @pytest.mark.asyncio
    async def test_delete_disciplina(self, client: AsyncClient, sample_disciplina):
        response = await client.delete(f"/disciplinas/{sample_disciplina.disciplina_id}")
        assert response.status_code == 200
        assert "deleted successfully" in response.json()["message"]

    @pytest.mark.asyncio
    async def test_delete_disciplina_not_found(self, client: AsyncClient):
        response = await client.delete("/disciplinas/999")
        assert response.status_code == 404
        assert "Disciplina not found" in response.json()["detail"]

    @pytest.mark.asyncio
    async def test_read_disciplinas_by_professor(self, client: AsyncClient, sample_disciplina, sample_professor):
    ...
    @pytest.mark.asyncio
    async def test_search_disciplinas_by_name(self, client: AsyncClient, sample_disciplina):
    ...
    @pytest.mark.asyncio
    async def test_search_disciplinas_no_results(self, client: AsyncClient):
